...
library(tidyverse)
class <- c("Brenna", "Anthony", "Abbas", "Sara", "Sarah", "Jonathan", "Harrison",
           "Tasheena", "Leonard", "Timothy", "Jenn", "Kiryu", "Jeff", "Vickie", 
           "Pei", "Luke", "Brendan", "Caleb", "Meron", "Christien", "Wayne", "Meredith")
set.seed(76)
...
rough topic outline:
    ...
    1. ~~Other methods~~
        ...
        * ~~Random forests~~
        * ~~Neural nets~~        
* **Source code**: The code to build this webpage is accesible by
clicking the GitHub icon on the top-right of the nav bar.


<!--
* Quiz on interpreting beta coefficients
-->
...
* Handed back quiz on "Weapons of Math Destruction" podcast from PS07. Two most chosen
examples from podcast were 1) recidivism/criminal justice system 2) teacher
evalutions. Some related material:
    1. Why does recidivism matter? See [Netflix's 13th](https://www.netflix.com/title/80091741) for one viewpoint.
    1. Teacher evaluations:
        a) A randomized controlled trial where they randomly assign gender? Small sample size, but the results are still depressing. [Best Way for Professors to Get Good Student Evaluations? Be Male.](http://www.slate.com/blogs/xx_factor/2014/12/09/gender_bias_in_student_evaluations_professors_of_online_courses_who_present.html)
        a) As high-minded as we faculty like to think we are, our sh*t stinks too: [Professors Are Prejudiced, Too](https://www.nytimes.com/2014/05/11/opinion/sunday/professors-are-prejudiced-too.html)
