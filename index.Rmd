...
* "Gah! I can't tell who you are from your Slack names!" Please go to: "STAT 495 Amherst..." on top left of Slack -> "Profile & account" -> "Edit Profile" and
    ...
    + Add a photo
* Andrew K. (TA) gave feedback on PS01 GitHub. You should've received an email notification, but feedback is best viewed with GitHub webpage GUI (graphical user interface). This will be done by Tuesday evenings for future problem sets.

## Chalk talk

1.5 How splines work
