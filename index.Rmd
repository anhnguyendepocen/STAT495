...
* Syllabus has been finalized, so please read it. I will politely decline to answer questions that are answered on the syllabus :)
    + Midterm dates
    + Andrew Kim's tutoring hours: Mondays 6pm-8pm starting today.
* All future Problem Sets will be assigned/due/presented on Tuesdays
