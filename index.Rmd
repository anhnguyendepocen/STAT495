...
<center><img src="images/rstudio_projects.png" alt="Drawing" style="height: 100px;"/> & <img src="images/Octocat.png" alt="Drawing" style="height: 100px;"/></center>

* RStudio projects:
    + Are folders of self-contained projects.
    + If a project is attached to a GitHub repository then the folders' contents match the GitHub repo online.
    + RStudio -> Tools -> Terminal -> New Terminal -> Type `cd .git`. This (invisible) folder contains git info
    + In RStudio on the top right, you should be working in the appropriate RStudio project.
* Keyboard shortcut of the day
* Philosophical fallacy of the day. *"Texas Sharpshooter Fallacy": When an argument is made and confirmed using the same set of information.*. Watch first 50s of this video: 

<iframe width="560" height="315" src="https://www.youtube.com/watch?v=_tcBsryYd6s" frameborder="0" allowfullscreen></iframe>
...
Recall from our [Intro to Splines]({#intro_to_splines}) lecture the different
fitted models based on different degrees of freedom (i.e. different numbers of
knots). What's going on at df=50 vs df=10?
