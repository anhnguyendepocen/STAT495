...
* **Tip of the day:** Another reason I'm a big fan of Slack, quick videoconferencing with screensharing using appear.
...
with the best out-of-sample predictive ability. The data include the following variables:
