...
= 0.95$.
* The learning goal of the assignment is not so much to show the
breakdown holds; we know this is true by probabilistic fact. Rather, the goal is
to understand what is random and what is not in the above breakdown; you'll only
be able to show the above breakdown by simulation if you understand these.
...
following files should be modified/added:
    ...
    both Andrew and I can open your `PS06.html` in a browser. **Please test this URL before submitting your work!**
