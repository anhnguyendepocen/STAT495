...
* PS06:
    ...
    + https://youtu.be/k0GNAJwxTnQ?t=2m31s
-->
...
* Albert is [calling an audible](https://english.stackexchange.com/posts/39307/revisions)!
    + Topic $k$-means clustering, an unsupervised learning technique, is now
bumped up from Mon 11/13 to Mon 10/30 + Tue 10/31
    + PS09 assigned on Tue 10/31, due Tue 11/7, will be on $k$-means clustering
    + Why? [Prof Rachel Ward](https://www.ma.utexas.edu/users/rachel/) of University of Texas at Austin will be giving a talk "Mathematics for $k$-means clustering and beyond" on Friday 11/10 4:30pm in Seeley Mudd 206.
...
### Outcome variable $y$ image

Setosa            |  Versicolor |  Virginica
:-------------------------:|:-------------------------:|:-------------------------:
<img src="images/iris_setosa.png" alt="Drawing" style="width: 250px;"/>  |  <img src="images/iris_versicolor.png" alt="Drawing" style="width: 250px;"/>  |  <img src="images/iris_virginica.png" alt="Drawing" style="width: 250px;"/>

### Predictor variables $\vec{X}$ image

<center><img src="images/petals_sepals.jpg" alt="Drawing" style="width: 300px;"/></center>
