...
**Note**: The source code for this Shiny app is available on <a target="_blank" class="page-link" href="https://github.com/rudeboybert/MATH218/blob/gh-pages/assets/classification/knn_shiny/knn_shiny.Rmd">GitHub</a>.
...
**Key Point**: Majority rules with ties broken at random.
