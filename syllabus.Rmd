...
* On due date, an `.Rmd` file that
    1. Is completely reproducible and easy for a new user to pick up and
    understand and replicate. New users include: other people, future you, and
    especially me!
    1. Loads all data
    1. Has an exploratory data analysis (EDA)
    1. Shows your work
    1. Creates a submission CSV file
* On due date, a two-page max summary PDF of your thinking:
