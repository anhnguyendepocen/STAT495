...
* **Meeting locations/times:**
    ...
    + **Office hours**: M 1:00-4:00 and W 2:00-5:00 in [Converse Hall 316](https://www.google.com/maps/place/Amherst+College+Converse+Hall/@42.3722517,-72.5207872,17z/data=!4m5!3m4!1s0x0:0x63162cb2397551a2!8m2!3d42.3723643!4d-72.5184167) (or by appointment).  
...
* **Objectives**: This semester you will
    ...
    1. Implement the ideas behind ["minimum viable products"](https://en.wikipedia.org/wiki/Lean_startup#Definitions) into your workflow.
...
* A typical lecture will consist of some balance of:
    ...
    * "Tech time": Unstructured time for you to either
        + Read digital content
          ...
          + Start problem sets
* The flow of the lecture notes will follow the notes on the [welcome page](index.html) of the course.   


## Attendance policy

I do not take explicit attendance, so there is no need to inform me of the occasional absences. That being said, abuse of this policy will eventually catch up to you (see [Engagement](#engagement) below). 
...
1. Background
    * Modeling at its simplest: $y = f(\vec{x}) + \epsilon$
    * Sampling
    * Crossvalidation
...
There will be three midterms: two during the semester, one during finals week (dates TBA).
